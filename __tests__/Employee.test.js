...
describe("Employee", () => {
    ...
    describe("getId", () => {
        it("Should return the Employee object's id: '1'", () => {
            const employee  = new Employee(name, id, email);
    ...
    describe("getEmail", () => {
        it("Should return the Employee object's email: 'Bob@gmail.com'", () => {
            const employee  = new Employee(name, id, email);
    ...
    describe("getRole", () => {
        it("Should return the Employee object's role: 'Employee'", () => {
            const employee  = new Employee(name, id, email);
